...
import static com.ajapps.pixie.FileSaveHelper.isSdkHigherThan28;
...
import com.ajapps.pixie.filters.FilterListener;
import com.ajapps.pixie.filters.FilterViewAdapter;
import com.ajapps.pixie.tools.EditingToolsAdapter;
import com.ajapps.pixie.tools.ToolType;
...
public class EditImageActivity extends BaseActivity implements OnPhotoEditorListener,
    ...
    public void onEditTextChangeListener(final View rootView, String text, int colorCode) {
        com.ajapps.pixie.TextEditorDialogFragment textEditorDialogFragment =
                com.ajapps.pixie.TextEditorDialogFragment.show(this, text, colorCode);
                ...
                if (fileCreated) {
                    ...
                    mPhotoEditor.saveAsFile(filePath, saveSettings, new PhotoEditor.OnSaveListener() {
                        ...
                        public void onSuccess(@NonNull String imagePath) {
                            ...
                            sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, mSaveImageUri));
                        }
    ...
    public void onToolSelected(ToolType toolType) {
        switch (toolType) {
            case SHAPE:
                ...
                break;
            case TEXT:
                com.ajapps.pixie.TextEditorDialogFragment textEditorDialogFragment = com.ajapps.pixie.TextEditorDialogFragment.show(this);
